create table T_CLIENTE (id bigint generated by default as identity, apellido varchar(50) not null, Provincia varchar(50) not null, calle varchar(50) not null, ciudad varchar(50) not null, codigoPostal varchar(50) not null, departamento varchar(50) not null, numeroCivico varchar(50) not null, piso varchar(50) not null, email varchar(255), nombre varchar(50) not null, telefono varchar(14), primary key (id));
create table T_CUENTABANCARIA (disc varchar(31) not null, id bigint generated by default as identity, descubiertoAcordado double not null, fechaCierre date, fechaCreacion date not null, nroCuenta bigint not null, saldoActual double not null, saldoInicial double not null, titular_id bigint not null, primary key (id));
...
create table T_MOVIMIENTO (disc varchar(31) not null, id bigint generated by default as identity, descripcion varchar(255) not null, fechaHora timestamp not null, monto double not null, primary key (id));
